...
```
    ...
    ## <environment: 0x0000026d53f989a8>
...
| Ridge               |   0.2788 |   0.9023 |                                     0.9991 |
| Elastic Net         |   0.2773 |   0.9022 |                                     0.9990 |
| Random Forest       |      Inf |   0.8998 |                                     0.9964 |

Based on **accuracy** in prediction of the test set, the “best model”
(of the models studied) for Education = College Graduate is
**Logistic**, which has accuracy = 0.9047.
...
accuracy of the most accurate model, Logistic, was: **1.002X** that of
“pick the most popular” model.
