...
#set label for reference in later sections
...
Since the dataset was unbalanced, it is informative to compare the accuracy of the model with a simple "pick the most popular model".  The accuracy of the most accurate model, `r comparison_results_test[1,1]`,  was: `r round(comparison_results_test[1,4],2)`X that of "pick the most popular" model.