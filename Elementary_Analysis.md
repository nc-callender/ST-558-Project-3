...
![](Elementary_Analysis_files/figure-gfm/Figure-1-1.png)<!-- -->
...
![](Elementary_Analysis_files/figure-gfm/Figure-2-1.png)<!-- -->
...
![](Elementary_Analysis_files/figure-gfm/Figure-3-1.png)<!-- -->
...
![](Elementary_Analysis_files/figure-gfm/Figure%204-1.png)<!-- -->
...
![](Elementary_Analysis_files/figure-gfm/Figure-5-1.png)<!-- -->
...
![](Elementary_Analysis_files/figure-gfm/Figure-6-1.png)<!-- -->
...
![](Elementary_Analysis_files/figure-gfm/Figure-7-1.png)<!-- -->
...
![](Elementary_Analysis_files/figure-gfm/Figure-8-1.png)<!-- -->
...
![](Elementary_Analysis_files/figure-gfm/Figure-9-1.png)<!-- -->
...
![](Elementary_Analysis_files/figure-gfm/Figure-10-1.png)<!-- -->
...
```
    ...
    ## <environment: 0x000001c8e427d840>
...
during cross validation is **Ridge** with log loss = 0.5165.
...
| Method              | Log Loss | Accuracy |
|:--------------------|---------:|---------:|
| Classification Tree |   0.5565 |   0.7186 |
...
|:--------------------|---------:|---------:|-------------------------------------------:|
| Random Forest       |      Inf |   0.7241 |                                     1.0223 |
| Logistic            |   0.5325 |   0.7225 |                                     1.0201 |
| LASSO               |   0.5278 |   0.7202 |                                     1.0167 |
| Classification Tree |   0.5565 |   0.7186 |                                     1.0145 |
| Ridge               |   0.5285 |   0.7154 |                                     1.0100 |
| Elastic Net         |   0.5285 |   0.7154 |                                     1.0100 |
| Most Popular        |       NA |   0.7083 |                                     1.0000 |

Based on **accuracy** in prediction of the test set, the “best model”
(of the models studied) for Education = Elementary is **Random Forest**,
which has accuracy = 0.7241.
...
set, the “best model” (of the models studied) for Education = Elementary
is **LASSO** with Log Loss = 0.5278.
...
corresponding to Education = Elementary. Some exploratary data analysis
was conducted producing summary tables and graphs. The dataset was then
split into training and test sets. Model training was conducted for the
following models:
...
Of these models, **Ridge** exhibited the lowest log loss during cross
validation with:  
Log Loss = 0.5165.
...
The model exhibiting the Lowest Log Loss was **LASSO** with:  
Log Loss = 0.5278.
