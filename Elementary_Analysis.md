...
```
    ...
    ## <environment: 0x0000026d57196260>
...
|:--------------------|---------:|---------:|-------------------------------------------:|
| Random Forest       |      Inf |   0.7233 |                                     1.0212 |
...
accuracy of the most accurate model, Random Forest, was: **1.021X** that
